...
class AppPalette {
  ...
  Color get bg => isDark ? const Color(0xFF0E0E12) : const Color(0xFFE8F8EE);
  ...
  Color get surfaceAlt => isDark ? const Color(0xFF1E1E26) : const Color(0xFFF0FBF5);
  Color get border => isDark ? const Color(0xFF2A2A33) : const Color(0xFFCAE8D5);
  Color get text => isDark ? const Color(0xFFF3F2EE) : const Color(0xFF0B1A10);
  Color get textMuted => isDark ? const Color(0xFF9A9AA6) : const Color(0xFF5A7060);
