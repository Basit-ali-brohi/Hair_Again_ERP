  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: _done ? const _SuccessState() : _FormState(
...
class _FormState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text('Set New Password', style: p.display(28), textAlign: TextAlign.center),
      const SizedBox(height: 8),
      Text('Choose a strong password with at least 8 characters.', style: p.body(14, color: p.textMuted), textAlign: TextAlign.center),
      ...
      Text('New Password', style: p.label(12)),
      const SizedBox(height: 8),
      TextField(
        controller: newCtrl, obscureText: obscNew, style: p.body(15),
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.lock_outline, size: 20, color: p.textMuted),
          hintText: 'Min. 8 characters',
          suffixIcon: IconButton(
            icon: Icon(obscNew ? Icons.visibility_outlined : Icons.visibility_off_outlined, size: 20, color: p.textMuted),
      ...
      Text('Confirm Password', style: p.label(12)),
      const SizedBox(height: 8),
      TextField(
        controller: confCtrl, obscureText: obscConf, style: p.body(15),
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.lock_outline, size: 20, color: p.textMuted),
          hintText: 'Re-enter new password',
          suffixIcon: IconButton(
            icon: Icon(obscConf ? Icons.visibility_outlined : Icons.visibility_off_outlined, size: 20, color: p.textMuted),
      ...
      Container(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 10),
          Expanded(child: Text('Use uppercase, lowercase, numbers and symbols for a strong password.', style: p.body(12, color: p.textMuted))),
        ]),
      ),
...
class _SuccessState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      const SizedBox(height: 28),
      Text('Password Updated!', style: p.display(26), textAlign: TextAlign.center),
      const SizedBox(height: 12),
      Text('Your password has been changed successfully.\nLogging you in...', style: p.body(14, color: p.textMuted), textAlign: TextAlign.center),
      const SizedBox(height: 28),
